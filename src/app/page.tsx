    ...
    <main className="bg-background">
      ...
      <section className="py-24 px-6 md:px-12 text-center max-w-4xl mx-auto">
        ...
        <p className="text-foreground/40 text-lg leading-relaxed font-light">
          Harpa is the creative vessel of Harry Prambudy, a director and storyteller based in Depok, Indonesia. Explore our collective works, experimental lab, and creative philosophy.
        </p>
      </section>
      <Footer />
    </main>
